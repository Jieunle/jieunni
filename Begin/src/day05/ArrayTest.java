...
public class ArrayTest {
	...
	public static void main(String[] args) {
		 ...
		 * [3] 초기화
		 * */
		//int [] c;  //[1]배열 선언		int c[3] (x)
		int c [];  //똑같음
		
		//[2]메모리 할당=> new 연산자 이용
		c=new int[3]; //배열의 크기를 정한다 (초기화하면서 배열 크기 정함)
		
		//[3] 초기화 : index 이용해서 데이터를 저장한다
		// 이때 index는 0부터 시작한다.
		c[0]=10;
		c[1]=20;
		c[2]=30;
		...
		//배열은 초기화를 하지 않으면 디폴트 값이 들어가기에 초기화 필수
		System.out.println("arr[0]="+arr[0]); //0.0(초기화 하지않을때 디폴트값)
		...
		char [] ch2= {'B','y','e'};  //배열선언과 동시에 배열 값까지 넣어줌0
